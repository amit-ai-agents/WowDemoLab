                  ...
                  <div class="card demo-card${nonLiveClass}">
                    <div class="card-body d-flex align-items-center gap-3">
                      ...
                      <div>
                        ...
                        <a class="btn btn-sm btn-outline-success w-100" href="${d.demoLink}" target="_blank">🚀Launch Demo</a>
                      </div>
                    </div>
                  </div>
                </div>`;
                ...
                <div class="col-md-4 mb-4">
                  <div class="card demo-card h-100 position-relative${nonLiveClass}">
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <div>
                        <button class="btn btn-sm btn-outline-primary me-2" style="font-size:12px;" onclick='quickDetails(${d.id})'><i class="bi bi-eye"></i> Demo Details</button>
                        <button class="btn btn-sm btn-outline-danger me-2" style="font-size:12px;" onclick='viewDetails(${d.id})'><i class="bi bi-box-arrow-up-right"></i> Solution Details</button>
                        <a class="btn btn-sm btn-outline-success" style="font-size:12px;" href="${d.demoLink}" target="_blank"> 🚀 Launch Demo</a>
                      </div>
                    </div>
                  </div>
                </div>`;
